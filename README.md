...
* Updated to newest espressif32 (3.1.0) - compilation is running
* update tflite for digits to version 8.1.0 (new numbers teached)
* internal preparation for fixed illumination (target: additional speedup)
