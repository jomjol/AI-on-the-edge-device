...
void IRAM_ATTR SmartLed::copyRmtHalfBlock() {
    ...
    if ( !len ) {
        for ( int i = 0; i < detail::MAX_PULSES; i++) {
            /* TODO ESP IDF 6.0.1: no longer available, see https://docs.espressif.com/projects/esp-idf/en/latest/esp32/migration-guides/release-5.x/5.0/peripherals.html?highlight=rmtmem#id5 */
